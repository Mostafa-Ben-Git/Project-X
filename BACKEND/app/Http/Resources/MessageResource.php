...
class MessageResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        try {
            if ($partnerId) {
                $enc = Crypt::encryptString($partnerId);
        ...
        return [
            ...
            'reply_to' => $this->relationLoaded('replyTo') && $this->replyTo ? [
                'id' => $this->replyTo->id,
                'content' => $this->replyTo->content ? Str::limit($this->replyTo->content, 80) : null,
            ...
            'sender' => [
                ...
                ...($this->sender?->presenceFor(request()->user()) ?? ['status' => null, 'last_active_at' => null]),
            ],
            'receiver' => [
                'id' => $this->receiver?->id,
                ...
                ...($this->receiver?->presenceFor(request()->user()) ?? ['status' => null, 'last_active_at' => null]),
            ],
        ];
    }
}
