        ...
        <div className="flex items-center space-x-4">
          {user && (
            <>
              ...
              <div>
                {user.age && <p className="text-white">Age: {user.age} ans</p>}
                {user.date_de_naissance && (
                  <p className="text-white">Né le: {user.date_de_naissance}</p>
                )}
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {user.ville_origine && (
                    <span className="text-white-600">{user.ville_origine}</span>
                  )}
                </div>
                <div className="flex items-center space-x-2">
                  <GraduationCap className="text-white-600" size={34} />
                  {user.education && (
                    <div className="text-white-600">{user.education}</div>
                  )}
                </div>
                {jsonObject && (
                  <div className="flex items-center space-x-4">
      ...
      <div className="mt-8">
        <div>
          ...
          <ul className="mt-4 flex flex-col gap-4">
            {posts &&
              posts?.map((post) => (
                <Post {...post} key={post.post_id} className="border" />
              ))}
          </ul>
        </div>
      </div>
